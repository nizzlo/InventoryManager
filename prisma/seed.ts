  ...
  await prisma.inventoryMove.createMany({
    data: [
      ...
      // Inventory adjustments
      {
        ...
        qty: new Decimal(-2),
        ref: 'ADJ-001',
        note: 'Damaged items write-off',
        userName: 'admin',
      },
      // Additional purchases with different pricing
      {
        itemId: mouse.id,
        locationId: warehouse.id,
        type: 'IN',
        qty: new Decimal(25),
        unitCost: new Decimal(27.99),
        sellPrice: new Decimal(42.99),
        ref: 'PO-002',
        note: 'Restocking order - new supplier',
        userName: 'admin',
      },
    ],
  })
